...
namespace FCT.EPS.WSP.SBWTSA.Resources
{
    public class LoggingHelper : Logging
    {
        ...
        {
            LogAuditingActivity(logMessage, AgentConstants.EventID.SEND_BATCH_WIRE_SWIFT_AGENT, TraceEventType.Information, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogAuditingActivity(new Exception(logMessage, ex), AgentConstants.EventID.SEND_BATCH_WIRE_SWIFT_AGENT, TraceEventType.Information, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogCriticalActivity(new Exception(logMessage), AgentConstants.EventID.SEND_BATCH_WIRE_SWIFT_AGENT, TraceEventType.Critical, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogCriticalActivity(new Exception(logMessage, ex), AgentConstants.EventID.SEND_BATCH_WIRE_SWIFT_AGENT, TraceEventType.Critical, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogCriticalActivity(ex, AgentConstants.EventID.SEND_BATCH_WIRE_SWIFT_AGENT, TraceEventType.Critical, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogWarningsActivity(new Exception(logMessage, ex), AgentConstants.EventID.SEND_BATCH_WIRE_SWIFT_AGENT, TraceEventType.Warning, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogWarningsActivity(ex, AgentConstants.EventID.SEND_BATCH_WIRE_SWIFT_AGENT, TraceEventType.Warning, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogWarningsActivity(new Exception(logMessage), AgentConstants.EventID.SEND_BATCH_WIRE_SWIFT_AGENT, TraceEventType.Warning, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }

        #region Error

        public static void LogErrorActivity(string logMessage, int priority, [System.Runtime.CompilerServices.CallerMemberName] string passedMemberName = "", [System.Runtime.CompilerServices.CallerFilePath] string passedSourceFilePath = "", [System.Runtime.CompilerServices.CallerLineNumber] int passedSourceLineNumber = 0)
        {
            LogErrorActivity(new Exception(logMessage), AgentConstants.EventID.SEND_BATCH_WIRE_SWIFT_AGENT, TraceEventType.Error, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, priority, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogErrorActivity(new Exception(logMessage), AgentConstants.EventID.SEND_BATCH_WIRE_SWIFT_AGENT, TraceEventType.Error, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogErrorActivity(new Exception(logMessage, ex), AgentConstants.EventID.SEND_BATCH_WIRE_SWIFT_AGENT, TraceEventType.Error, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogErrorActivity(ex, AgentConstants.EventID.SEND_BATCH_WIRE_SWIFT_AGENT, TraceEventType.Error, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
