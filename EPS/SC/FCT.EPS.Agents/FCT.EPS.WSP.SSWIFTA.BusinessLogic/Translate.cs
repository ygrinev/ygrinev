...
namespace FCT.EPS.WSP.SSWIFTA.BusinessLogic
{
    class Translate
    {
        internal static Swift.MT101DataValues EPSDataToMT101DataValues(DataEntities.tblPaymentRequest myFirsttblPaymentRequest)
        {
            return new Swift.MT101DataValues()
            {
                ...
                YourReference = myFirsttblPaymentRequest.PaymentTransactionID.ToString(),
                PaymentDueDate = myFirsttblPaymentRequest.PaymentRequestDate,
                PaymentCurrency = AgentConstants.Misc.PAYMENT_CURRENCY,
                PaymentAmount = myFirsttblPaymentRequest.PaymentAmount,
