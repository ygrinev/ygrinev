...
namespace FCT.EPS.WSP.SCTFA.Implementation
{
    public class SendChequesToFinance : MarshalByRefObject, IAgent, IDisposable
    {
        ...
        public SendChequesToFinance()
        {
            SolutionTraceClass.appTraceSwitch = new TraceSwitch(AgentConstants.Misc.LOGGING_APPLICATION_TITLE, "FCT.EPS.WSP.SendAgents Defined in config file.");
        ...
        private void GetConfigValues()
        {
            ...
            if (!IsConfigFileRead)
            {
                try
                {
                    this.milliseconds = Properties.Settings.Default.SendChequesToFinanceAgentIntervalInMilliSeconds;
        ...
        private void TimerTick(object stateInfo)
        {
            ...
            try
            {
                ...
                BusinessLayer.StartProcess(this.recordsToGet, this.endpoint, this.numberOfRetries);
