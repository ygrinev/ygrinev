...
{
     public class PaymentTrackingWebServiceClient : WebServiceChannelFactory2<IPaymentTrackingService> 
    {
         public PaymentTrackingWebServiceClient(string endpointConfigurationName)
             : base(endpointConfigurationName)
     {

     }
        public PaymentNotificationResponse SubmitRequestToPaymentTrackerWebService(PaymentNotificationRequest paymentTrackerRequest, string servceEndPoint)
        {
