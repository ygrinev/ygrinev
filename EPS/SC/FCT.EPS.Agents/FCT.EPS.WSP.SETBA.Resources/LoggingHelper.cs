...
namespace FCT.EPS.WSP.SETBA.Resources
{
    public class LoggingHelper : Logging
    {
        ...
        {
            LogAuditingActivity(logMessage, AgentConstants.EventID.SEND_ELECTRONIC_TO_BANK_AGENT, TraceEventType.Information, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogAuditingActivity(new Exception(logMessage, ex), AgentConstants.EventID.SEND_ELECTRONIC_TO_BANK_AGENT, TraceEventType.Information, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogCriticalActivity(new Exception(logMessage), AgentConstants.EventID.SEND_ELECTRONIC_TO_BANK_AGENT, TraceEventType.Critical, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogCriticalActivity(new Exception(logMessage, ex), AgentConstants.EventID.SEND_ELECTRONIC_TO_BANK_AGENT, TraceEventType.Critical, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogCriticalActivity(ex, AgentConstants.EventID.SEND_ELECTRONIC_TO_BANK_AGENT, TraceEventType.Critical, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogWarningsActivity(new Exception(logMessage, ex), AgentConstants.EventID.SEND_ELECTRONIC_TO_BANK_AGENT, TraceEventType.Warning, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogWarningsActivity(ex, AgentConstants.EventID.SEND_ELECTRONIC_TO_BANK_AGENT, TraceEventType.Warning, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogWarningsActivity(new Exception(logMessage), AgentConstants.EventID.SEND_ELECTRONIC_TO_BANK_AGENT, TraceEventType.Warning, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogErrorActivity(new Exception(logMessage), AgentConstants.EventID.SEND_ELECTRONIC_TO_BANK_AGENT, TraceEventType.Error, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, AgentConstants.Misc.LOGGING_BUSINESS_RULES_PRIORITY, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogErrorActivity(new Exception(logMessage, ex), AgentConstants.EventID.SEND_ELECTRONIC_TO_BANK_AGENT, TraceEventType.Error, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, AgentConstants.Misc.LOGGING_BUSINESS_RULES_PRIORITY, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
        ...
        {
            LogErrorActivity(ex, AgentConstants.EventID.SEND_ELECTRONIC_TO_BANK_AGENT, TraceEventType.Error, AgentConstants.Misc.LOGGING_APPLICATION_TITLE, AgentConstants.Misc.LOGGING_BUSINESS_RULES_PRIORITY, passedMemberName, passedSourceFilePath, passedSourceLineNumber);
        }
