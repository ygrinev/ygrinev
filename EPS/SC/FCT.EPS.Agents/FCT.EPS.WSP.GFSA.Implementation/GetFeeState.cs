...
namespace FCT.EPS.WSP.GFSA.Implementation
{
    public class FeeStateAgent : MarshalByRefObject, IAgent, IDisposable
    {
        ...
        public FeeStateAgent()
        {
            SolutionTraceClass.appTraceSwitch = new TraceSwitch(AgentConstants.Misc.LOGGING_APPLICATION_TITLE, "FCT.EPS.WSP.GFSA Defined in config file.");
        ...
        private void GetConfigValues()
        {
            ...
            if (!IsConfigFileRead)
            {
                try
                {
                    this.milliseconds = Properties.Settings.Default.GetFeeStateIntervalInMilliSeconds;
        ...
        private void TimerTick(object stateInfo)
        {
            ...
            try
            {
                ...
                BusinessLayer.ProcessFeeStatus(this.recordsToGet, this.endpoint);
