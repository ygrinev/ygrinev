...
{
    public class RBCRejectedTranactionsBodyMap
    {
        private static SortedDictionary<int, DataField> FileBodyDictionary;

        public RBCRejectedTranactionsBodyMap()
        {
        }
        ...
        private static SortedDictionary<int, DataField> InitializeRBCFileBodyMap()
        {
            if (FileBodyDictionary == null)
            {
                ...
                FileBodyDictionary.Add(1, new DataField(string.Empty, "RecordType", TypeCode.Int32, "{0,#:FIX#}", 2,"#","",""));
                ...
                FileBodyDictionary.Add(13, new DataField(string.Empty, "CreditLine", TypeCode.Int32, "{0:00000000,FIX#}",8,"#","",""));
                ...
                FileBodyDictionary.Add(29, new DataField(string.Empty, "RequestedAmount", TypeCode.Int32, "{0:FIX#}",9,"#","",""));
                FileBodyDictionary.Add(30, new DataField(string.Empty, "BalanceTransferAmount", TypeCode.Decimal, "{0:0000000000000,FIX#,RBCDEC}",13,"#","",""));
                ...
                FileBodyDictionary.Add(34, new DataField(string.Empty, "ReservationSolicitationNumber", TypeCode.String, "{0:0000000000000000,FIX#}",16,"#","",""));
                FileBodyDictionary.Add(35, new DataField(string.Empty, "TandemAuthorizationCode", TypeCode.String, "{0,-#:FIX#}",6,"#","",""));
                FileBodyDictionary.Add(36, new DataField(string.Empty, "PaymentReferenceNumber", TypeCode.String, "{0,-#:FIX#}",26,"#","",""));
    ...
    public class RBCRejectedTranactionsBodyDataValues : BaseDataValues
    {
        ...
        [DefaultValue("")]
        public string ReservationSolicitationNumber { get; set; }
        [DefaultValue("")]
        ...
        public IList<string> ErrorStrings { get; set; }

        public RBCRejectedTranactionsBodyDataValues()
        {
            ErrorStrings = new List<string>();
        }
    }
    public class RBCRejectedTranactionsFileBodyProcessor<T> : BaseProcess<T>
    {
        public RBCRejectedTranactionsFileBodyProcessor(T value)
        {
            fileFormatDictionary = RBCRejectedTranactionsBodyMap.GetMap();
            datavalue = value;
        }
